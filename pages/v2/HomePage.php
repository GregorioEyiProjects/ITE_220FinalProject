<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET") {
        ...
        //$userGmail_coming = $_POST['user_gmail_going'] ?? null; 
    
        echo "Movie ID: " . $movieId_coming . "<br>";
        echo "User Name: " . $userName_coming . "<br>";
        echo "User Hashed Password: " . $user_hashed_pass_coming . "<br>";
        
    
        if ($userName_coming && $user_hashed_pass_coming) {
            
            //$_SESSION['id_user_going'] = $id_user;
            $id_user = get_id_user_by_name_and_password($userName_coming, $user_hashed_pass_coming);
            var_dump($id_user); // Debugging
            ...
            <?php
                if($filtered_movies->num_rows > 0){
                    while($row = $filtered_movies->fetch_assoc()){
                        echo "<div class='movie_item'>"; // Add a wrapper for each movie item
                            ...
                            echo "<div class='movie_details_container'>";
                                ...
                                echo "<div class='movie_description_container' >";
                                    ...
                                    echo "<div class='movie_title_container'>";
                                        ...
                                        echo "<span class='add_movie_btn_container'>";
                                            //var_dump($user_gmail);
                                            echo "<button onclick='handleAddToWatchlist(" . $row["id_movie"] . ", \"" . addslashes($username) . "\", \"".addslashes($user_hashed_pass)."\")' class='add_movie_btn hover-button2'>";
                                                echo "<i class='fa fa-add moreCss'>";
                                                echo "</i>";
                                            echo "</button>";
                                ...
                                echo "<div class='movie_link_container'>";
                                    echo "<button class='movie_btn'>";
                                        echo "<a href='MovieDescription.php?id=".$row["id_movie"]."' class='movie_link_2'>Watch</a>";
                                    echo "</button>";
                                echo "</div>";
